...
function loadDynamicContent() {
    ...
    image.style.border="solid 10px green";
...
function createAlarm() {
    ...
    if(newAlarm === displayString{
        error("Enter Unique Title",'red')
    }
    // TODO 
...
function error(messg,colour){
    messg.style.color =color;
    messg.textContent=messg;
